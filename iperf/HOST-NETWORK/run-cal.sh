...
other_tags=",cni:calico,test:sams" # Comma-separated list of something=value, these help you identify this run as different
...
ocphost=f33-h17-000-r640.rdu2.scalelab.redhat.com # must be able to ssh without password prompt
