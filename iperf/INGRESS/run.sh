...
################################################
topo="ingress" # internode = client/server pods on different nodes in ocp/k8s cluster
...
ocphost=perf154.perf.lab.eng.bos.redhat.com # must be able to ssh without password prompt
...
#####################################
bmlhosta=perf154.perf.lab.eng.bos.redhat.com # Used for topo=ingress|egress|interhost
